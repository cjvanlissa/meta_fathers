...
Fathers play unique role in children's language development<font size="2">  
...
They use more varied/challenging language than mothers<font size="2">  
([Tamis-LeMonda, Baumwell, & Cristofaro, 2012](https://doi.org/10.1177/0142723711419321))</font>

This expands children's vocabulary<font size="2">  
([Pancsofar & Vernon-Feagans, 2010](https://doi.org/10.1016/j.ecresq.2010.02.001); [Rowe, Coker, & Pan, 2004](https://doi.org/10.1111/j.1467-9507.2004.000267.x))</font>

Latest meta-analysis covered studies until 2008<font size="2">  
([McWayne, Downer, Campos, & Harris, 2013](https://doi.org/10.1080/10409289.2013.746932))</font>

* Average correlation of .08 (5 effect sizes)
...
Moreover, we set
out to code a comprehensive list of moderators, pertaining to publication characteristics, sample, study design,


## Methods

Preliminary search (Web of Science): 4991 records, 92 included

Full search, based on meta-data from 92 articles:

* Web of Science
* PsychInfo
* ERIC

Additional 2194 relevant records, 52 new articles

Total articles: 144, of which `r max(analyzedat$id_study)` reported sufficient statistical information to compute a total of `r nrow(analyzedat)` effect sizes.
...
Multilevel meta-analysis for dependent effect sizes (Van den Noortgate et al., 2013)
...
4. **Else**, drop the variable with most negative variable importance, go back to Step 2
...
kable(table_mods, row.names = FALSE) %>%
...
Metaforest analysis  
(["metaforest" R-package, Van Lissa, 2017](https://cran.r-project.org/package=metaforest))
...
Finding the optimal analysis settings
...
Optimal model: uniform weights, 4 candidate variables, min node size 2
...
Variable importance reflects contribution to predictions

Encompasses main effects/interactions/non-linear effects

Variables ranked from most to least important
...
## Bivariate marginal associations

Bivariate marginal associations show the "main effect" of each variable

Averaging over the values of all other predictors
...
* Stronger effects for research at home (ecological validity?)
* Stronger effects for assessments/observations than questionnaires
* Stronger effects for trained researchers than for parent/self-reports

**Statistical**

* Stronger effects for cross-sectional than longitudinal research (dissipation over time)
* High dropout rate: Higher effect size (selection effect)
* Partial correlations tend to be stronger, especially with more controls


## Implications for adolescence

Fathers continue to be relevant

Instead of language development, examine cognitive development